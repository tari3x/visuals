...
module Vector2 = struct
  ...
  let create x y = new%js constr x y
end
...
module Vector3 = struct
  ...
  let create x y z = new%js constr x y z
end
...
module Matrix4 = struct
  ...
  let constr : t constr = Js.Unsafe.global ##. THREE ##. Matrix4
...
module Color = struct
  ...
  let create r g b = new%js constr r g b
end
...
module TextureLoader = struct
  ...
  class type js =
    object
      ...
      method load :
        js_string Js.t -> (Texture.t -> unit) callback -> unit meth
    end

  type t = js Js.t

  let constr : t constr = Js.Unsafe.global ##. THREE ##. TextureLoader
  let create () = new%js constr
end
...
module VideoTexture = struct
  ...
  let create video = new%js constr video
end
...
module Geometry = struct
  ...
  class type js =
    object
      ...
      method faceVertexUvs :
        Vector2.t js_array Js.t js_array Js.t js_array Js.t prop
  ...
  let constr : t constr = Js.Unsafe.global ##. THREE ##. Geometry
  let create () = new%js constr
end
...
module Material = struct
  ...
  let constr : t constr = Js.Unsafe.global ##. THREE ##. Material
  let create () = new%js constr
end
...
module MeshBasicMaterial = struct
  ...
  let create ?color ?map () = new%js constr (Params.create ?color ?map ())
end
...
module Object3D = struct
  ...
  let constr : t constr = Js.Unsafe.global ##. THREE ##. Object3D
  let create () = new%js constr
end
...
module Mesh = struct
  ...
  let create g m = new%js constr g m
end
...
module Camera = struct
  ...
  let constr : t constr = Js.Unsafe.global ##. THREE ##. Camera
  let create () = new%js constr
end
...
module Scene = struct
  ...
  let constr : t constr = Js.Unsafe.global ##. THREE ##. Scene
  let create () = new%js constr
end
...
module WebGLRenderer = struct
  ...
  let constr : t constr = Js.Unsafe.global ##. THREE ##. WebGLRenderer
  let create () = new%js constr
end
