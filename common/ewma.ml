...
let create ~half_life =
  ...
  { value = None; last_sample_param = 0.; decay }
;;
...
let%expect_test _ =
  ...
  print ();
  [%expect
    {| (t((value())(last_sample_param 0)(decay 0.69314718055994529))) |}];
  add 1. 1.;
  [%expect
    {| (t((value(1))(last_sample_param 1)(decay 0.69314718055994529))) |}];
  add 2. 1.;
  [%expect
    {| (t((value(1))(last_sample_param 2)(decay 0.69314718055994529))) |}];
  add 3. 4.;
  [%expect
    {| (t((value(2.5))(last_sample_param 3)(decay 0.69314718055994529))) |}]
;;
