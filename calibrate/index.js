...
(function(joo_global_object)
   {"use strict";
    ...
    var
     ...
     _d2_=caml_new_string("OCAMLRUNPARAM"),
     _d0_=caml_new_string("CAMLRUNPARAM"),
     _bW_=caml_new_string(""),
     _b5_=[3,0,3],
     ...
     _dR_=caml_new_string("math.config({ matrix: 'array' })"),
     _dT_=
      [0,
        ...
        for(;;)
         {if(param$0)
           {var l=param$0[2],a=param$0[1];
            try {caml_ml_flush(a)}catch(_kl_){}
            var param$0=l;
            continue}
          return 0}}
    ...
    function contains_from(s,i,c)
     {var l=caml_ml_string_length(s);
      if(0 <= i)
       if(!(l < i))
        try
         {index_rec(s,l,i,c);var _kj_=1;return _kj_}
        catch(_kk_)
         {_kk_ = caml_wrap_exception(_kk_);
          if(_kk_ === Not_found)return 0;
          throw _kk_}
    ...
    function _C_(Ord)
     {function height(param){if(param){var h=param[5];return h}return 0}
      function create(l,x,d,r)
       {var hl=height(l),hr=height(r),_kf_=hr <= hl?hl + 1 | 0:hr + 1 | 0;
      ...
      function bal(l,x,d,r)
       {if(l)var h=l[5],hl=h;else var hl=0;
        ...
        if((hr + 2 | 0) < hl)
         {if(l)
           {var lr=l[4],ld=l[3],lv=l[2],ll=l[1],_ka_=height(lr);
            if(_ka_ <= height(ll))return create(ll,lv,ld,create(lr,x,d,r));
            if(lr)
             {var
               lrr=lr[4],
               lrd=lr[3],
               lrv=lr[2],
               lrl=lr[1],
               _kb_=create(lrr,x,d,r);
              return create(create(ll,lv,ld,lrl),lrv,lrd,_kb_)}
            return invalid_arg(_u_)}
          return invalid_arg(_v_)}
        if((hl + 2 | 0) < hr)
         {if(r)
           {var rr=r[4],rd=r[3],rv=r[2],rl=r[1],_kc_=height(rl);
            if(_kc_ <= height(rr))return create(create(l,x,d,rl),rv,rd,rr);
            if(rl)
             {var
               rlr=rl[4],
               rld=rl[3],
               rlv=rl[2],
               rll=rl[1],
               _kd_=create(rlr,rv,rd,rr);
              return create(create(l,x,d,rll),rlv,rld,_kd_)}
            return invalid_arg(_w_)}
          return invalid_arg(_x_)}
        var _ke_=hr <= hl?hl + 1 | 0:hr + 1 | 0;
        return [0,l,x,d,r,_ke_]}
      var empty=0;
      ...
      function min_binding(param)
       {var param$0=param;
        for(;;)
         {if(param$0)
           {var _j__=param$0[1];
            if(_j__){var param$0=_j__;continue}
      ...
      function max_binding(param)
       {var param$0=param;
        for(;;)
         {if(param$0)
           {var _j7_=param$0[4],_j8_=param$0[3],_j9_=param$0[2];
            if(_j7_){var param$0=_j7_;continue}
            return [0,_j9_,_j8_]}
          throw Not_found}}
         ...
         {var _j6_=param[1];
          if(_j6_)
           {var r=param[4],d=param[3],x=param[2];
            return bal(remove_min_binding(_j6_),x,d,r)}
          var r$0=param[4];
          return r$0}
        ...
        for(;;)
         {if(param$0)
           {var
             ...
             v=param$0[2],
             l=param$0[1],
             _j3_=caml_call2(p,v,d);
            if(_j3_)
             {var _j4_=for_all(p,l);
              if(_j4_){var param$0=r;continue}
              var _j5_=_j4_}
            else
             var _j5_=_j3_;
            return _j5_}
        ...
        for(;;)
         {if(param$0)
           {var
             ...
             v=param$0[2],
             l=param$0[1],
             _j0_=caml_call2(p,v,d);
            if(_j0_)
             var _j1_=_j0_;
            else
             {var _j2_=exists(p,l);
              if(!_j2_){var param$0=r;continue}
              var _j1_=_j2_}
            return _j1_}
          return 0}}
         ...
         {var h1=s1[5],r1=s1[4],d1=s1[3],v1=s1[2],l1=s1[1];
          if(height(s2) <= h1)
           {var
             ...
             l2=match[1],
             _jW_=merge(f,r1,r2),
             _jX_=caml_call3(f,v1,[0,d1],d2);
            return concat_or_join(merge(f,l1,l2),v1,_jX_,_jW_)}}
        else
         if(!s2)return 0;
        if(s2)
         {var
           ...
           d1$0=match$0[2],
           l1$0=match$0[1],
           _jY_=merge(f,r1$0,r2$0),
           _jZ_=caml_call3(f,v2,d1$0,[0,d2$0]);
          return concat_or_join(merge(f,l1$0,l2$0),v2,_jZ_,_jY_)}
      ...
      function partition(p,param)
       {if(param)
         {var
           ...
           rf=match$0[2],
           rt=match$0[1];
          if(pvd){var _jU_=concat(lf,rf);return [0,join(lt,v,d,rt),_jU_]}
          var _jV_=join(lf,v,d,rf);
          return [0,concat(lt,rt),_jV_]}
        return _B_}
         ...
         {if(e1)
           {if(e2)
             {var
               ...
               d1=e1[2],
               v1=e1[1],
               _jR_=0 === caml_call2(Ord[1],v1,v2)?1:0;
              if(_jR_)
               {var _jS_=caml_call2(cmp,d1,d2);
                if(_jS_)
                 {var
                   e2$1=cons_enum(r2,e2$0),
                   e1$1=cons_enum(r1,e1$0),
      ...
      function cardinal(param)
       {if(param)
         {var r=param[4],l=param[1],_jQ_=cardinal(r);
          return (cardinal(l) + 1 | 0) + _jQ_ | 0}
        return 0}
    ...
    function fmtty_rel_det(param)
     {if(typeof param === "number")
       {var
        ...
        return [0,function(param){return 0},_js_,_jr_,_jq_]}
      else
       switch(param[0])
        {case 0:
          var
           ...
           af=match[2],
           fa=match[1],
           _jt_=function(param){caml_call1(af,0);return 0};
          return [0,function(param){caml_call1(fa,0);return 0},_jt_,ed,de];
         case 1:
          var
           rest$0=param[1],
           ...
           af$0=match$0[2],
           fa$0=match$0[1],
           _ju_=function(param){caml_call1(af$0,0);return 0};
          return [0,
         ...
         case 2:
          var
           ...
           af$1=match$1[2],
           fa$1=match$1[1],
           _jv_=function(param){caml_call1(af$1,0);return 0};
          return [0,
         ...
         case 3:
          var
           ...
           af$2=match$2[2],
           fa$2=match$2[1],
           _jw_=function(param){caml_call1(af$2,0);return 0};
          return [0,
         ...
         case 4:
          var
           ...
           af$3=match$3[2],
           fa$3=match$3[1],
           _jx_=function(param){caml_call1(af$3,0);return 0};
          return [0,
         ...
         case 5:
          var
           ...
           af$4=match$4[2],
           fa$4=match$4[1],
           _jy_=function(param){caml_call1(af$4,0);return 0};
          return [0,
         ...
         case 6:
          var
           ...
           af$5=match$5[2],
           fa$5=match$5[1],
           _jz_=function(param){caml_call1(af$5,0);return 0};
          return [0,
         ...
         case 7:
          var
           ...
           af$6=match$6[2],
           fa$6=match$6[1],
           _jA_=function(param){caml_call1(af$6,0);return 0};
          return [0,
         ...
         case 8:
          var
           ...
           af$7=match$7[2],
           fa$7=match$7[1],
           _jB_=function(param){caml_call1(af$7,0);return 0};
          return [0,
         ...
         case 9:
          var
           ...
           ga=match$9[2],
           ag=match$9[1],
           _jC_=function(param){caml_call1(jd,0);caml_call1(de$8,0);return 0},
           _jD_=function(param){caml_call1(ed$8,0);caml_call1(dj,0);return 0},
           _jE_=function(param){caml_call1(ga,0);caml_call1(af$8,0);return 0};
          return [0,
                  function(param)
         ...
         case 10:
          var
           ...
           af$9=match$10[2],
           fa$9=match$10[1],
           _jF_=function(param){caml_call1(af$9,0);return 0};
          return [0,
         ...
         case 11:
          var
           ...
           af$10=match$11[2],
           fa$10=match$11[1],
           _jG_=function(param){caml_call1(af$10,0);return 0};
          return [0,
         ...
         case 12:
          var
           ...
           af$11=match$12[2],
           fa$11=match$12[1],
           _jH_=function(param){caml_call1(af$11,0);return 0};
          return [0,
         ...
         case 13:
          var
           ...
           af$12=match$13[2],
           fa$12=match$13[1],
           _jI_=function(param){caml_call1(de$12,0);return 0},
           _jJ_=function(param){caml_call1(ed$12,0);return 0},
           _jK_=function(param){caml_call1(af$12,0);return 0};
          return [0,
         ...
         default:
          var
           ...
           af$13=match$14[2],
           fa$13=match$14[1],
           _jL_=function(param){caml_call1(de$13,0);return 0},
           _jM_=function(param){caml_call1(ed$13,0);return 0},
           _jN_=function(param){caml_call1(af$13,0);return 0};
          return [0,
       ...
       switch(ty1[0])
        {case 0:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 0:var rest2=match[1];return [0,trans(_i9_,rest2)];
         ...
         case 1:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 1:var rest2$0=match[1];return [1,trans(_i__,rest2$0)];
         ...
         case 2:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 2:var rest2$1=match[1];return [2,trans(_i$_,rest2$1)];
         ...
         case 3:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 3:var rest2$2=match[1];return [3,trans(_ja_,rest2$2)];
         ...
         case 4:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 4:var rest2$3=match[1];return [4,trans(_jb_,rest2$3)];
         ...
         case 5:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 5:var rest2$4=match[1];return [5,trans(_jc_,rest2$4)];
         ...
         case 6:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 6:var rest2$5=match[1];return [6,trans(_jd_,rest2$5)];
         ...
         case 7:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 7:var rest2$6=match[1];return [7,trans(_je_,rest2$6)];
          ...
          break;
         case 8:
          var _jf_=ty1[2],_jg_=ty1[1];
          if(typeof match === "number")
           var switch$9=1;
          else
           switch(match[0])
            {case 8:
              var rest2$7=match[2],ty2=match[1],_jh_=trans(_jf_,rest2$7);
              return [8,trans(_jg_,ty2),_jh_];
          ...
          break;
         case 9:
          var _ji_=ty1[3],_jj_=ty1[2],_jk_=ty1[1];
          if(typeof match === "number")
           var switch$10=1;
          else
           switch(match[0])
            {case 8:var switch$0=5,switch$10=0;break;
             case 9:
              var
               ...
               ty22=match[2],
               ty21=match[1],
               ty=trans(symm(_jj_),ty21),
               match$0=fmtty_rel_det(ty),
               f4=match$0[4],
               f2=match$0[2];
              caml_call1(f2,0);
              caml_call1(f4,0);
              return [9,_jk_,ty22,trans(_ji_,rest2$8)];
         ...
         case 10:
          ...
          if(typeof match !== "number" && 10 === match[0])
           {var rest2$9=match[1];return [10,trans(_jl_,rest2$9)]}
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$11=0;break;
             case 11:var rest2$10=match[1];return [11,trans(_jm_,rest2$10)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$12=0;break;
             ...
             case 12:var rest2$11=match[1];return [12,trans(_jn_,rest2$11)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$13=0;break;
             ...
             case 13:var rest2$12=match[1];return [13,trans(_jo_,rest2$12)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$14=0;break;
             ...
             case 14:var rest2$13=match[1];return [14,trans(_jp_,rest2$13)];
     ...
     {var match=type_padding(pad,fmtty);
      if(typeof prec === "number")
       {if(0 === prec)
        ...
        var _i8_=match[2];
        if(typeof _i8_ !== "number" && 2 === _i8_[0])
         {var rest$0=_i8_[1],pad$1=match[1];return [0,pad$1,1,rest$0]}
        throw Type_mismatch}
        ...
        {case 0:
         ...
         case 2:
          ...
          if(typeof _iH_ !== "number" && 1 === _iH_[0])
           {var
             ...
             fmtty$2=match$1[2],
             fmt$2=match$1[1];
            return [0,[2,_iI_,fmt$2],fmtty$2]}
          throw Type_mismatch;
         case 3:
          var
           fmt_rest$2=fmt[2],
           pad$0=fmt[1],
           _iJ_=type_padding(pad$0,fmtty),
           _iK_=_iJ_[2],
           _iL_=_iJ_[1];
         ...
         case 4:
          var
           ...
           pad$1=fmt[2],
           iconv=fmt[1],
           _iM_=type_padprec(pad$1,prec,fmtty),
           _iN_=_iM_[3],
           _iO_=_iM_[2],
           _iP_=_iM_[1];
          if(typeof _iN_ !== "number" && 2 === _iN_[0])
           {var
             fmtty_rest$3=_iN_[1],
             match$3=type_format_gen(fmt_rest$3,fmtty_rest$3),
             fmtty$4=match$3[2],
             fmt$4=match$3[1];
            return [0,[4,iconv,_iP_,_iO_,fmt$4],fmtty$4]}
          throw Type_mismatch;
         case 5:
          var
           fmt_rest$4=fmt[4],
           ...
           pad$2=fmt[2],
           iconv$0=fmt[1],
           _iQ_=type_padprec(pad$2,prec$0,fmtty),
           _iR_=_iQ_[3],
           _iS_=_iQ_[2],
           _iT_=_iQ_[1];
          if(typeof _iR_ !== "number" && 3 === _iR_[0])
           {var
             fmtty_rest$4=_iR_[1],
             match$4=type_format_gen(fmt_rest$4,fmtty_rest$4),
             fmtty$5=match$4[2],
             fmt$5=match$4[1];
            return [0,[5,iconv$0,_iT_,_iS_,fmt$5],fmtty$5]}
          throw Type_mismatch;
         case 6:
          var
           fmt_rest$5=fmt[4],
           ...
           pad$3=fmt[2],
           iconv$1=fmt[1],
           _iU_=type_padprec(pad$3,prec$1,fmtty),
           _iV_=_iU_[3],
           _iW_=_iU_[2],
           _iX_=_iU_[1];
          if(typeof _iV_ !== "number" && 4 === _iV_[0])
           {var
             fmtty_rest$5=_iV_[1],
             match$5=type_format_gen(fmt_rest$5,fmtty_rest$5),
             fmtty$6=match$5[2],
             fmt$6=match$5[1];
            return [0,[6,iconv$1,_iX_,_iW_,fmt$6],fmtty$6]}
          throw Type_mismatch;
         case 7:
          var
           fmt_rest$6=fmt[4],
           ...
           pad$4=fmt[2],
           iconv$2=fmt[1],
           _iY_=type_padprec(pad$4,prec$2,fmtty),
           _iZ_=_iY_[3],
           _i0_=_iY_[2],
           _i1_=_iY_[1];
          if(typeof _iZ_ !== "number" && 5 === _iZ_[0])
           {var
             fmtty_rest$6=_iZ_[1],
             match$6=type_format_gen(fmt_rest$6,fmtty_rest$6),
             fmtty$7=match$6[2],
             fmt$7=match$6[1];
            return [0,[7,iconv$2,_i1_,_i0_,fmt$7],fmtty$7]}
          throw Type_mismatch;
         case 8:
          var
           fmt_rest$7=fmt[4],
           ...
           pad$5=fmt[2],
           fconv=fmt[1],
           _i2_=type_padprec(pad$5,prec$3,fmtty),
           _i3_=_i2_[3],
           _i4_=_i2_[2],
           _i5_=_i2_[1];
          if(typeof _i3_ !== "number" && 6 === _i3_[0])
           {var
             fmtty_rest$7=_i3_[1],
             match$7=type_format_gen(fmt_rest$7,fmtty_rest$7),
             fmtty$8=match$7[2],
             fmt$8=match$7[1];
            return [0,[8,fconv,_i5_,_i4_,fmt$8],fmtty$8]}
          throw Type_mismatch;
         case 9:
         ...
         case 14:
          if(typeof fmtty !== "number" && 9 === fmtty[0])
           {var
             ...
             sub_fmtty$1=fmt[2],
             pad_opt$0=fmt[1],
             _i6_=[0,erase_rel(sub_fmtty1)];
            if(caml_notequal([0,erase_rel(sub_fmtty$1)],_i6_))
             throw Type_mismatch;
            var
            ...
            {case 0:return type_ignored_param_one(ign,rest,fmtty);
             ...
             case 8:
              var
               sub_fmtty$3=ign[2],
               pad_opt$2=ign[1],
               _i7_=type_ignored_format_substitution(sub_fmtty$3,rest,fmtty),
               match$27=_i7_[2],
               fmtty$22=match$27[2],
               fmt$22=match$27[1],
               sub_fmtty$4=_i7_[1];
      ...
      for(;;)
       {if(caml_ml_string_length(str) <= i$1)
         ...
         {var match$0=caml_string_unsafe_get(str,i$1);
          if(32 <= match$0)
           {var _iB_=match$0 - 34 | 0;
            if(58 < _iB_ >>> 0)
             if(93 <= _iB_)var switch$0=0,switch$1=0;else var switch$1=1;
            else
             if(56 < (_iB_ - 1 | 0) >>> 0)
              var switch$0=1,switch$1=0;
             else
          ...
          var _iC_=switch$0?1:1}
        if(_iC_)
         {var n=[0,0],_iu_=caml_ml_string_length(str) - 1 | 0,_it_=0;
          if(!(_iu_ < 0))
           {var i$0=_it_;
            for(;;)
             {var match=caml_string_unsafe_get(str,i$0);
              if(32 <= match)
               {var _iy_=match - 34 | 0;
                if(58 < _iy_ >>> 0)
                 if(93 <= _iy_)var switch$2=0,switch$3=0;else var switch$3=1;
                else
                 if(56 < (_iy_ - 1 | 0) >>> 0)
                  var switch$2=1,switch$3=0;
                 else
                  var switch$3=1;
                if(switch$3)var _iz_=1,switch$2=2}
              else
               var switch$2=11 <= match?13 === match?1:0:8 <= match?1:0;
              switch(switch$2)
               {case 0:var _iz_=4;break;case 1:var _iz_=2;break}
              n[1] = n[1] + _iz_ | 0;
              var _iA_=i$0 + 1 | 0;
              if(_iu_ !== i$0){var i$0=_iA_;continue}
              break}}
          if(n[1] === caml_ml_string_length(str))
           ...
           {var s=caml_create_string(n[1]);
            n[1] = 0;
            var _iw_=caml_ml_string_length(str) - 1 | 0,_iv_=0;
            if(!(_iw_ < 0))
             {var i=_iv_;
              for(;;)
    ...
    function convert_int(iconv,n)
     {switch(iconv)
       {case 0:var _is_=_av_;break;
        case 1:var _is_=_aw_;break;
        case 2:var _is_=_ax_;break;
        case 3:var _is_=_ay_;break;
        case 4:var _is_=_az_;break;
        case 5:var _is_=_aA_;break;
        case 6:var _is_=_aB_;break;
        case 7:var _is_=_aC_;break;
        case 8:var _is_=_aD_;break;
        case 9:var _is_=_aE_;break;
        case 10:var _is_=_aF_;break;
        case 11:var _is_=_aG_;break;
        default:var _is_=_aH_}
      return caml_format_int(_is_,n)}
    function convert_int32(iconv,n)
     {switch(iconv)
       {case 0:var _ir_=_aV_;break;
        case 1:var _ir_=_aW_;break;
        case 2:var _ir_=_aX_;break;
        case 3:var _ir_=_aY_;break;
        case 4:var _ir_=_aZ_;break;
        case 5:var _ir_=_a0_;break;
        case 6:var _ir_=_a1_;break;
        case 7:var _ir_=_a2_;break;
        case 8:var _ir_=_a3_;break;
        case 9:var _ir_=_a4_;break;
        case 10:var _ir_=_a5_;break;
        case 11:var _ir_=_a6_;break;
        default:var _ir_=_a7_}
      return caml_format_int(_ir_,n)}
    function convert_nativeint(iconv,n)
     {switch(iconv)
       {case 0:var _iq_=_a8_;break;
        case 1:var _iq_=_a9_;break;
        case 2:var _iq_=_a__;break;
        case 3:var _iq_=_a$_;break;
        case 4:var _iq_=_ba_;break;
        case 5:var _iq_=_bb_;break;
        case 6:var _iq_=_bc_;break;
        case 7:var _iq_=_bd_;break;
        case 8:var _iq_=_be_;break;
        case 9:var _iq_=_bf_;break;
        case 10:var _iq_=_bg_;break;
        case 11:var _iq_=_bh_;break;
        default:var _iq_=_bi_}
      return caml_format_int(_iq_,n)}
    function convert_int64(iconv,n)
     {switch(iconv)
       {case 0:var _ip_=_aI_;break;
        case 1:var _ip_=_aJ_;break;
        case 2:var _ip_=_aK_;break;
        case 3:var _ip_=_aL_;break;
        case 4:var _ip_=_aM_;break;
        case 5:var _ip_=_aN_;break;
        case 6:var _ip_=_aO_;break;
        case 7:var _ip_=_aP_;break;
        case 8:var _ip_=_aQ_;break;
        case 9:var _ip_=_aR_;break;
        case 10:var _ip_=_aS_;break;
        case 11:var _ip_=_aT_;break;
        default:var _ip_=_aU_}
      return caml_int64_format(_ip_,n)}
     ...
     {if(16 <= fconv)
       {if(17 <= fconv)
        ...
        if(19 <= fconv)
         {var l=caml_ml_string_length(s);
          if(0 === l)return s;
          var r=caml_create_string(l),_ij_=l - 1 | 0,_ii_=0;
          if(!(_ij_ < 0))
           {var i=_ii_;
            for(;;)
             {var c=caml_string_unsafe_get(s,i);
              if(97 <= c)
               if(122 < c)var switch$1=0;else var _ik_=c - 32 | 0,switch$1=1;
              else
               var switch$1=0;
              if(!switch$1)var _ik_=c;
              caml_string_unsafe_set(r,i,_ik_);
              var _il_=i + 1 | 0;
              if(_ij_ !== i){var i=_il_;continue}
              break}}
          return r}
        return s}
      if(15 === fconv)
       ...
       {var prec=abs(prec$0);
        ...
        var _im_=buffer_contents(buf)}
      var str=caml_format_float(_im_,x);
      if(15 === fconv)
        ...
        for(;;)
         {if(i$0 === len)
           ...
           {var
             ...
             _in_=match - 46 | 0,
             switch$2=
              23 < _in_ >>> 0?55 === _in_?1:0:21 < (_in_ - 1 | 0) >>> 0?1:0;
            if(!switch$2){var i$1=i$0 + 1 | 0,i$0=i$1;continue}
            var _io_=1}
          return _io_?str:_a_(str,_bn_)}}
      return str}
    function make_int_padding_precision(k,o,acc,fmt,pad,match,trans,iconv)
     {if(typeof pad === "number")
       ...
       {if(0 === pad[0])
         {var _if_=pad[2],_ig_=pad[1];
          if(typeof match === "number")
           return 0 === match
                   ?function(x)
                     {var str=fix_padding(_ig_,_if_,caml_call2(trans,iconv,x));
                      return make_printf(k,o,[4,acc,str],fmt)}
                   :function(p,x)
                     {var
                       str=
                        fix_padding
                         (_ig_,_if_,fix_int_precision(p,caml_call2(trans,iconv,x)));
                      return make_printf(k,o,[4,acc,str],fmt)};
          var p$0=match[1];
          return function(x)
           {var
             str=
              fix_padding
               (_ig_,_if_,fix_int_precision(p$0,caml_call2(trans,iconv,x)));
            return make_printf(k,o,[4,acc,str],fmt)}}
        var _ih_=pad[1];
        if(typeof match === "number")
         return 0 === match
                 ?function(w,x)
                   {var str=fix_padding(_ih_,w,caml_call2(trans,iconv,x));
                    return make_printf(k,o,[4,acc,str],fmt)}
                 :function(w,p,x)
                   {var
                     str=
                      fix_padding
                       (_ih_,w,fix_int_precision(p,caml_call2(trans,iconv,x)));
                    return make_printf(k,o,[4,acc,str],fmt)};
        var p$1=match[1];
        return function(w,x)
         {var
           str=
            fix_padding
             (_ih_,w,fix_int_precision(p$1,caml_call2(trans,iconv,x)));
          return make_printf(k,o,[4,acc,str],fmt)}}}
         ...
         {case 0:
          ...
          case 8:
           ...
           if(typeof pad$5 === "number")
            ...
            {if(0 === pad$5[0])
              {var _ia_=pad$5[2],_ib_=pad$5[1];
               if(typeof prec$3 === "number")
                return 0 === prec$3
                        ?function(x)
                          {var
                            str=convert_float(fconv,default_float_precision,x),
                            str$0=fix_padding(_ib_,_ia_,str);
                           return make_printf(k$0,o,[4,acc$0,str$0],rest$7)}
                        :function(p,x)
                          {var str=fix_padding(_ib_,_ia_,convert_float(fconv,p,x));
                           return make_printf(k$0,o,[4,acc$0,str],rest$7)};
               var p$0=prec$3[1];
               return function(x)
                {var str=fix_padding(_ib_,_ia_,convert_float(fconv,p$0,x));
                 return make_printf(k$0,o,[4,acc$0,str],rest$7)}}
             var _ic_=pad$5[1];
             if(typeof prec$3 === "number")
              return 0 === prec$3
                      ?function(w,x)
                        {var
                          str=convert_float(fconv,default_float_precision,x),
                          str$0=fix_padding(_ic_,w,str);
                         return make_printf(k$0,o,[4,acc$0,str$0],rest$7)}
                      :function(w,p,x)
                        {var str=fix_padding(_ic_,w,convert_float(fconv,p,x));
                         return make_printf(k$0,o,[4,acc$0,str],rest$7)};
             var p$1=prec$3[1];
             return function(w,x)
              {var str=fix_padding(_ic_,w,convert_float(fconv,p$1,x));
               return make_printf(k$0,o,[4,acc$0,str],rest$7)}}
          case 9:
           var rest$8=fmt$0[1];
           return function(b)
            {var _ie_=b?_b_:_c_;
             return make_printf(k$0,o,[4,acc$0,_ie_],rest$8)};
          case 10:
          ...
          case 14:
           ...
           return function(param)
            {var
              ...
              _id_=type_format_gen(fmt$0,fmtty$0);
             if(typeof _id_[2] === "number")
              {var fmt=_id_[1];
          ...
          default:
           ...
           if(counter < 50)
            {var counter$0=counter + 1 | 0;
             return make_custom$0(counter$0,k$0,o,acc$0,rest$19,arity,_h$_)}
           return caml_trampoline_return
                   (make_custom$0,[0,k$0,o,acc$0,rest$19,arity,_h$_])}}
    ...
    function make_invalid_arg(counter,k,o,acc,fmt)
     {var _h8_=[8,acc,_bu_];
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,o,_h8_,fmt)}
      return caml_trampoline_return(make_printf$0,[0,k,o,_h8_,fmt])}
    function make_custom$0(counter,k,o,acc,rest,arity,f)
     {if(arity)
      ...
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,o,_h7_,rest)}
      return caml_trampoline_return(make_printf$0,[0,k,o,_h7_,rest])}
    ...
    function fprintf(oc,fmt$0)
     {var fmt=fmt$0[1],_h2_=0;
      return make_printf
              (function(o,acc){output_acc(o,acc);return 0},oc,_h2_,fmt)}
    ...
    function other_fields(x,i)
     {if(x.length - 1 <= i)return _bC_;
      var _h0_=other_fields(x,i + 1 | 0),_h1_=field(x,i);
      return caml_call2(sprintf(_bD_),_h1_,_h0_)}
    function fields(x)
     {var n=x.length - 1;
      if(2 < n >>> 0)
       {var _hX_=other_fields(x,2),_hY_=field(x,1);
        return caml_call2(sprintf(_bE_),_hY_,_hX_)}
      switch(n)
       {case 0:return _bF_;
        case 1:return _bG_;
        default:var _hZ_=field(x,1);return caml_call1(sprintf(_bH_),_hZ_)}}
        ...
        for(;;)
         {if(param$0)
           {var tl=param$0[2],hd=param$0[1];
            try {var _hV_=caml_call1(hd,x),_hU_=_hV_}catch(_hW_){var _hU_=0}
            if(_hU_){var s=_hU_[1];return s}
            var param$0=tl;
            continue}
     ...
     {try
       {var
         _hR_=
          [0,
           map$0
            (function(_hT_){return caml_convert_raw_backtrace_slot(_hT_)},
             rbckt)];
        return _hR_}
      catch(_hS_)
       {_hS_ = caml_wrap_exception(_hS_);
        if(_hS_[1] === Failure)return 0;
        throw _hS_}}
    function print_backtrace(outchan)
     {var
      ...
      if(backtrace)
       {var a=backtrace[1],_hP_=a.length - 1 - 1 | 0,_hO_=0;
        if(!(_hP_ < 0))
         {var i=_hO_;
          for(;;)
           {var
            ...
            if(0 === slot[0])
             var
              ...
              match=
               [0,
                caml_call5
                 (sprintf(_bR_),_hM_,filename,lineno,startchar,endchar)];
            else
             if(0 === slot[1])
              var _hN_=info(0),match=[0,caml_call1(sprintf(_bS_),_hN_)];
             else
              var match=0;
    ...
    try
     {var _d3_=caml_sys_getenv(_d2_),params=_d3_}
    catch(_hK_)
     {_hK_ = caml_wrap_exception(_hK_);
      if(_hK_ !== Not_found)throw _hK_;
      try
       {var _d1_=caml_sys_getenv(_d0_),_bX_=_d1_}
      catch(_hL_)
        ...
        {var
         ...
         for(;;)
          {caml_check_bound(result[1],i$0)[i$0 + 1] = i$0;
           var _hI_=i$0 + 1 | 0;
           if(54 !== i$0){var i$0=_hI_;continue}
           var accu=[0,_bV_],_hE_=54 + max(55,l) | 0,_hD_=0;
           if(!(_hE_ < 0))
            {var i=_hD_;
             for(;;)
              {var
               ...
               var
                _hF_=accu[1],
                _hz_=caml_string_get(_hF_,3) << 24,
                _hA_=caml_string_get(_hF_,2) << 16,
                _hB_=caml_string_get(_hF_,1) << 8,
                _hC_=
                 ((caml_string_get(_hF_,0) + _hB_ | 0) + _hA_ | 0)
                 +
                 _hz_
                 |
                 0,
                _hG_=
                 (caml_check_bound(result[1],j)[j + 1] ^ _hC_)
                 &
                 1073741823;
               caml_check_bound(result[1],j)[j + 1] = _hG_;
               var _hH_=i + 1 | 0;
     ...
     {if(opt)var sth=opt[1],random=sth;else var random=randomized_default;
      ...
      for(;;)
       {if(!(initial_size <= x))
        ...
        if(random)
         {var
           _hx_=caml_obj_tag(prng),
           _hy_=250 === _hx_?prng[1]:246 === _hx_?force_lazy_block(prng):prng;
          _hy_[2] = (_hy_[2] + 1 | 0) % 55 | 0;
          var
           _hu_=_hy_[2],
           curval=caml_check_bound(_hy_[1],_hu_)[_hu_ + 1],
           _hv_=(_hy_[2] + 24 | 0) % 55 | 0,
           newval=
            caml_check_bound(_hy_[1],_hv_)[_hv_ + 1]
            +
           ...
           _hw_=_hy_[2];
          caml_check_bound(_hy_[1],_hw_)[_hw_ + 1] = newval30;
          var seed=newval30}
        else
         var seed=0;
        return [0,0,caml_make_vect(x,0),seed,x]}}
    function add_queue(x,q)
     {var c=[0,[0,x,0]],_ht_=q[1];
      if(_ht_){var cell=_ht_[1];q[1] = c;cell[2] = c;return 0}
      q[1] = c;
      q[2] = c;
      return 0}
    ...
    function take_queue(q)
     {var _hs_=q[2];
      if(_hs_)
       {var match=_hs_[1],x=match[1],tl=match[2];
        q[2] = tl;
        if(0 === tl)q[1] = 0;
        return x}
      throw Empty_queue}
    ...
    function break_new_line(state,offset,width)
     {pp_output_newline(state);
      ...
      var
       ...
       _hr_=state[8],
       real_indent=caml_lessequal(_hr_,y)?_hr_:y;
     ...
     {if(typeof param === "number")
       switch(param)
        {case 0:
         ...
         case 1:
          var _he_=state[2];
          if(_he_){var ls=_he_[2];state[2] = ls;return 0}
          return 0;
         case 2:
          var _hf_=state[3];
          if(_hf_){var ls$0=_hf_[2];state[3] = ls$0;return 0}
          return 0;
         case 3:
          var _hg_=state[2];
          if(_hg_)
           {var match$0=_hg_[1],width=match$0[2];
            return break_line(state,width)}
          return pp_output_newline(state);
         case 4:
          var _hh_=state[10] !== (state[6] - state[9] | 0)?1:0;
          return _hh_?pp_skip_token(state):_hh_;
         default:
          var _hi_=state[5];
          if(_hi_)
           {var
       ...
       switch(param[0])
        {case 0:
          ...
          return 0;
         case 1:
          var off=param[2],n=param[1],_hj_=state[2];
          if(_hj_)
           {var match$1=_hj_[1],width$0=match$1[2],ty=match$1[1];
            switch(ty)
          ...
          if(_hk_)
           {var
            ...
            if(_hl_)
             {var x=_hl_[1];
              try
               {var _hm_=find(insertion_point,tabs$0[1]),x$0=_hm_}
              catch(_hn_)
       ...
       {var _g$_=state[27][2];
        if(_g$_)
         {var
           ...
           tok=x[2],
           _ha_=size < 0?1:0,
           _hb_=_ha_?(state[13] - state[12] | 0) < state[9]?1:0:_ha_,
           _hc_=1 - _hb_;
          if(_hc_)
           {take_queue(state[27]);
    ...
    function advance_left(state)
     {try
       {var _g9_=advance_loop(state);return _g9_}
      catch(_g__)
       {_g__ = caml_wrap_exception(_g__);
        if(_g__ === Empty_queue)return 0;
        throw _g__}}
         ...
         switch(tok[0])
          {case 3:
            var
             _g7_=1 - ty,
             _g8_=
              _g7_?(queue_elem[1] = state[13] + size | 0,state[1] = t,0):_g7_;
            return _g8_;
           case 1:
           case 2:
            var
    ...
    function default_pp_print_open_tag(_g4_){return 0}
    function default_pp_print_close_tag(_g3_){return 0}
    function make_formatter(output,flush)
     {function i(_g2_){return 0}
      function h(_g1_){return 0}
      ...
      var
       ...
       ppf=
        [0,
         ...
         pp_queue];
      ppf[19] = function(_g0_){return caml_call3(ppf[17],_b0_,0,1)};
      ppf[20]
      =
      function(n$1)
       {var n=n$1;
    ...
    function formatter_of_out_channel(oc)
     {function _gY_(param){return caml_ml_flush(oc)}
    ...
    function formatter_of_buffer(b)
     {function _gT_(_gX_){return 0}
      return make_formatter
              (function(s,offset,len)
                {var _gU_=offset < 0?1:0;
                 if(_gU_)
                  var _gV_=_gU_;
                 else
                  var
       ...
       {if(1 < state[14])
        ...
        if(state[14] < state[15])
         ...
         if(state[14] === state[15])
          {var
            _gR_=state[16],
            size=caml_ml_string_length(_gR_),
            tok=[0,size,[0,_gR_],size];
    ...
    function public_method_label(s)
     {var accu=[0,0],_gN_=caml_ml_string_length(s) - 1 | 0,_gM_=0;
      if(!(_gN_ < 0))
       {var i=_gM_;
        for(;;)
         {var _gO_=caml_string_get(s,i);
          accu[1] = (223 * accu[1] | 0) + _gO_ | 0;
          var _gP_=i + 1 | 0;
    ...
    function new_table(pub_labels)
     {table_count[1]++;
      ...
      var _gG_=((fit_size(len) * 32 | 0) / 8 | 0) - 1 | 0;
      caml_check_bound(methods,1)[2] = _gG_;
      var _gI_=len - 1 | 0,_gH_=0;
      if(!(_gI_ < 0))
       {var i=_gH_;
        for(;;)
         {var
           _gK_=(i * 2 | 0) + 3 | 0,
           _gJ_=caml_check_bound(pub_labels,i)[i + 1];
          caml_check_bound(methods,_gK_)[_gK_ + 1] = _gJ_;
          var _gL_=i + 1 | 0;
          if(_gI_ !== i){var i=_gL_;continue}
          break}}
      return [0,initial_object_size,methods,Meths[1],Labs[1],0,0,Vars[1],0]}
    function resize$0(array,new_size)
     {var len=array[2].length - 1,_gD_=len < new_size?1:0;
      if(_gD_)
       {var
         ...
         switch$0=
          0 <= len
           ?(_gE_.length - 1 - len | 0) < 0
             ...
             :(a2.length - 1 - len | 0) < 0
               ?0
               :(caml_array_blit(_gE_,0,a2,0,len),1)
           :0;
    ...
    function get_method_label(table,name)
     {try
       {var _gB_=caml_call2(Meths[23],name,table[3]);return _gB_}
      catch(_gC_)
    ...
    function new_variable(table,name)
     {try
       {var _gz_=caml_call2(Vars[23],name,table[7]);return _gz_}
      catch(_gA_)
    ...
    function repr_rec(t)
     {var _gv_=t[1];
      if(3 === _gv_[0])
       {var t$0=_gv_[1],t$1=repr_rec(t$0);
    ...
    function call_unsafe(f,x)
     {try
       {var _gu_=caml_call1(f,x);return _gu_}
      catch(exn)
     ...
     {var
      ...
      for(;;)
       {if(0 === q[1]){wakening[1] = 0;current_data[1] = snapshot;return 0}
        var _gq_=q[2];
        if(_gq_)
         {var _gr_=_gq_[1],_gs_=_gq_[2];
          if(_gs_)
           {q[1] = q[1] - 1 | 0;q[2] = _gs_}
          else
           {q[1] = 0;q[2] = 0;q[3] = 0}
          unsafe_run_waiters(_gr_[1],_gr_[2]);
          continue}
        throw Empty}}
    ...
    function wakeup(t$0,v)
     {var result=[0,v],t=repr_rec(t$0),_gp_=t[1];
      switch(_gp_[0])
       {case 1:if(_gp_[1] === Canceled)return 0;break;
        case 2:
         var sleeper=_gp_[1],state=state_of_result(result);
         t[1] = state;
         return safe_run_waiters(sleeper,state)
        }
      return invalid_arg(_b__)}
    function wakeup_later_result(t,result)
     {var t$0=repr_rec(t),_go_=t$0[1];
      switch(_go_[0])
       {case 1:if(_go_[1] === Canceled)return 0;break;
        case 2:
         var sleeper=_go_[1],state=state_of_result(result);
         t$0[1] = state;
         if(wakening[1])
          {var x=[0,sleeper,state],cell=[0,x,0],_gn_=q[3];
           return _gn_
                   ?(q[1] = q[1] + 1 | 0,_gn_[2] = cell,q[3] = cell,0)
     ...
     {if(typeof ws !== "number")
       switch(ws[0])
        {case 0:if(!ws[1][1])return 0;break;
         case 2:
          var l2=ws[2],l1=ws[1],_gm_=cleanup(l2);
          return append(cleanup(l1),_gm_)
         }
      return ws}
    ...
    function add_waiter(sleeper,waiter)
     {var
       _gf_=sleeper[2],
       waiter$0=typeof _gf_ === "number"?waiter:[2,waiter,_gf_];
      sleeper[2] = waiter$0;
      return 0}
    ...
    function on_cancel(t,f)
     {var _gd_=repr(t)[1];
      ...
      return 0}
    function _ce_(t$0,f)
     {var t=repr(t$0),_ga_=t[1];
      switch(_ga_[0])
       {case 0:var v=_ga_[1];return caml_call1(f,v);
        case 1:return [0,_ga_];
        case 2:
         var sleeper=_ga_[1],res=temp(t),data=current_data[1];
           ...
           function(state)
            {switch(state[0])
              {case 0:
                ...
                current_data[1] = data;
                try
                 {var _gc_=caml_call1(f,v),_gb_=_gc_}
    ...
    function catch$0(x,f)
     {try
       {var _f9_=caml_call1(x,0),_f7_=_f9_}
      catch(exn){exn = caml_wrap_exception(exn);var _f7_=fail(exn)}
      var t=repr(_f7_),_f8_=t[1];
      switch(_f8_[0])
       {case 0:return t;
        case 1:var exn=_f8_[1];return caml_call1(f,exn);
        case 2:
         var sleeper=_f8_[1],res=temp(t),data=current_data[1];
         add_immutable_waiter
          (sleeper,
           function(state)
            {switch(state[0])
              {case 0:return fast_connect(res,state);
               case 1:
                ...
                current_data[1] = data;
                try
                 {var _f$_=caml_call1(f,exn),_f__=_f$_}
                catch(exn){exn = caml_wrap_exception(exn);var _f__=fail(exn)}
                return connect(res,_f__);
               default:throw [0,Assert_failure,_cf_]}});
         return res;
        default:throw [0,Assert_failure,_cg_]}}
    function async(f)
     {try
       {var _f6_=caml_call1(f,0),_f4_=_f6_}
      catch(exn){exn = caml_wrap_exception(exn);var _f4_=fail(exn)}
      var t=repr(_f4_),_f5_=t[1];
      switch(_f5_[0])
       {case 0:return 0;
        case 1:var exn=_f5_[1];return caml_call1(async_exception_hook[1],exn);
        case 2:
         var sleeper=_f5_[1];
     ...
     {switch(repr(t)[1][0])
       {case 2:
         var
          t$0=task_aux(0),
          waiter=[],
          waiter$0=function _f3_(_f2_){return _f3_.fun(_f2_)};
         caml_update_dummy(waiter,[0,[0,waiter$0]]);
         caml_update_dummy
          (waiter$0,
           function(state)
            {var t=repr(t$0),_f1_=t[1];
             if(2 === _f1_[0])
              {var sleeper=_f1_[1];
               t[1] = state;
               return unsafe_run_waiters(sleeper,state)}
         ...
         iter
          (function(t)
            {var _f0_=repr(t)[1];
             if(2 === _f0_[0])
              {var sleeper=_f0_[1];return add_waiter(sleeper,node)}
            ...
            {waiter[1] = 0;
             ...
             return iter
                     (function(t)
                       {var _fX_=repr(t)[1];
                        if(2 === _fX_[0])
                         {var _fY_=_fX_[1],_fZ_=_fY_[2];
                          if(typeof _fZ_ !== "number" && 0 === _fZ_[0])
                           {_fY_[2] = 0;return 0}
                          var removed=_fY_[3] + 1 | 0;
                          return 42 < removed
                                  ?(_fY_[3] = 0,_fY_[2] = cleanup(_fY_[2]),0)
                                  :(_fY_[3] = removed,0)}
                        return 0},
                      l)});
         return t$0;
        ...
        default:return t}}
    var pause_hook=[0,function(_fW_){return 0}],s1=create$2(0),_cl_=[0,0];
     ...
     {var t=t$1;
      for(;;)
       {var _fU_=t[1];
        switch(_fU_[0])
         {case 2:return 1;
          case 3:var t$0=_fU_[1],t=t$0;continue;
          default:return 0}}}
    var
    ...
    function enqueue(e,last)
     {var _fT_=last[1],new_last=new_node(0);
      _fT_[2] = e;
      _fT_[1] = new_last;
      last[1] = new_last;
      return 0}
    ...
    make_class
     (shared,
      function(table)
       {var
         _fj_=new_variable(table,_cp_),
         _fk_=new_variable(table,_cq_),
         _fl_=new_variable(table,_cr_),
         _fm_=new_variable(table,_cs_),
         ...
         {var i$0=_e$_;
          for(;;)
           {var
            ...
            caml_check_bound(res,i$0)[i$0 + 1] = _fg_;
            var _fh_=i$0 + 1 | 0;
            if(_fa_ !== i$0){var i$0=_fh_;continue}
            break}}
        var _fc_=nvals - 1 | 0,_fb_=0;
        if(!(_fc_ < 0))
         {var i=_fb_;
          for(;;)
           {var
             _fe_=i + nmeths | 0,
             _fd_=new_variable(table,caml_check_bound(vals,i)[i + 1]);
            caml_check_bound(res,_fe_)[_fe_ + 1] = _fd_;
            var _ff_=i + 1 | 0;
        ...
        var
         ...
         _ft_=res[7],
         _fu_=res[8];
        function _fw_(self_1,x){self_1[_fj_ + 1][8] = x;return 0}
        function _fx_(self_1){return self_1[_fv_ + 1]}
        function _fy_(self_1){return 0 !== self_1[_fj_ + 1][5]?1:0}
        function _fz_(self_1){return self_1[_fj_ + 1][4]}
        function _fA_(self_1)
         {var _fR_=1 - self_1[_fv_ + 1];
          if(_fR_)
           {self_1[_fv_ + 1] = 1;
            var _fS_=self_1[_fl_ + 1][1],new_last=new_node(0);
            _fS_[2] = 0;
            _fS_[1] = new_last;
            self_1[_fl_ + 1][1] = new_last;
            if(0 !== self_1[_fj_ + 1][5])
             {self_1[_fj_ + 1][5] = 0;
              wakeup_later_result(self_1[_fj_ + 1][7],[1,e])}
            if(self_1[_fj_ + 1][2])
             {self_1[_fj_ + 1][2] = 0;
              var old_wakener=self_1[_fk_ + 1][1];
              wakeup_later(old_wakener,0)}
            return wakeup(self_1[_fm_ + 1],0)}
          return _fR_}
        function _fB_(self_1,x)
         {if(self_1[_fv_ + 1])return fail(e);
          if(0 === self_1[_fj_ + 1][5])
           {if(self_1[_fj_ + 1][3] <= self_1[_fj_ + 1][4])
             {self_1[_fj_ + 1][5] = [0,x];
              var
               _fQ_=
                function(exn)
                 {if(exn === Canceled)
                   {self_1[_fj_ + 1][5] = 0;
                    ...
                    self_1[_fj_ + 1][6] = waiter;
                    self_1[_fj_ + 1][7] = wakener;
                    return fail(exn)}
                  return fail(exn)};
              return catch$0(function(param){return self_1[_fj_ + 1][6]},_fQ_)}
            enqueue([0,x],self_1[_fl_ + 1]);
            self_1[_fj_ + 1][4] = self_1[_fj_ + 1][4] + 1 | 0;
            if(self_1[_fj_ + 1][2])
             {self_1[_fj_ + 1][2] = 0;
              var
               old_wakener=self_1[_fk_ + 1][1],
               match=wait(0),
               new_wakener=match[2],
               new_waiter=match[1];
              self_1[_fj_ + 1][1] = new_waiter;
              self_1[_fk_ + 1][1] = new_wakener;
              wakeup_later(old_wakener,0)}
            return return_unit}
          return fail(Full)}
        function _fC_(self_1,size)
         {if(size < 0)invalid_arg(_ct_);
          self_1[_fj_ + 1][3] = size;
          var
           _fO_=self_1[_fj_ + 1][4] < self_1[_fj_ + 1][3]?1:0,
           _fP_=_fO_?0 !== self_1[_fj_ + 1][5]?1:0:_fO_;
          return _fP_
                  ?(self_1[_fj_ + 1][4]
                    =
                    self_1[_fj_ + 1][4]
                    ...
                    |
                    0,
                    notify_pusher(self_1[_fj_ + 1],self_1[_fl_ + 1]))
                  :_fP_}
        var
         methods=
          [0,
           _fn_,
           function(self_1){return self_1[_fj_ + 1][3]},
           _fp_,
           _fC_,
           _fq_,
           _fB_,
        ...
        for(;;)
         {if(i$1[1] < len)
           {var
             _fi_=i$1[1],
             label=caml_check_bound(methods,_fi_)[_fi_ + 1],
             next=
              function(param)
               {i$1[1]++;
                var _fN_=i$1[1];
                return caml_check_bound(methods,_fN_)[_fN_ + 1]},
             clo=next(0);
               ...
               case 19:
                var
                 ...
                 clo$0=
                  function(n,m)
                    {return function(obj)
                      {var _fL_=caml_call1(obj[1][m + 1],obj);
                       return caml_call2(obj[1][n + 1],obj,_fL_)}}
                   (n$15,m$1);
                break;
               case 20:
                ...
                var
                 clo$0=
                  function(m,n)
                    {return function(obj)
                      {var _fK_=obj[n + 1];
                       return caml_call1(caml_get_public_method(_fK_,m,0),_fK_)}}
                   (m$3,n$16);
                break;
               case 22:
                ...
                var
                 clo$0=
                  function(m,e,n)
                    {return function(obj)
                      {var _fJ_=obj[e + 1][n + 1];
                       return caml_call1(caml_get_public_method(_fJ_,m,0),_fJ_)}}
                   (m$4,e$5,n$17);
                break;
               default:
                ...
                var
                 clo$0=
                  function(m,n)
                    {return function(obj)
                      {var _fM_=caml_call1(obj[1][n + 1],obj);
                       return caml_call1(caml_get_public_method(_fM_,m,0),_fM_)}}
                   (m$5,n$18)}
            else
             var clo$0=clo;
            method_count[1]++;
            ...
            i$1[1]++;
            continue}
          return function(_fH_,obj_0,_fG_,_fF_,_fE_,_fD_)
           {if(obj_0)
             var _fI_=obj_0;
            else
             {var obj=caml_obj_block(248,table[1]);
              obj[1] = table[2];
              var _fI_=caml_set_oo_id(obj)}
            _fI_[_fm_ + 1] = _fD_;
            _fI_[_fl_ + 1] = _fE_;
            _fI_[_fk_ + 1] = _fF_;
            _fI_[_fj_ + 1] = _fG_;
      ...
      switch(_e9_[0])
       {case 0:
         ...
         var
          ...
          thread=_ce_(caml_call1(from[1],0),_e__);
         from[2] = thread;
         return protected$0(thread);
        case 1:
         var f=_e9_[1],x=caml_call1(f,0);
         enqueue$0(x,s);
         if(0 === x)wakeup(s[2],0);
         return return_unit;
        case 2:var push=_e9_[1];push[2] = 1;return protected$0(push[1]);
        default:var push$0=_e9_[1];push$0[2] = 1;return protected$0(push$0[1])}}
    function consume(s,node)
     {var _e7_=node === s[3]?1:0;
      if(_e7_)
       {s[3] = node[1];
        var _e8_=s[1];
        if(3 === _e8_[0])
    ...
    function get_rec(s,node)
     {if(node === s[4][1])
       {var _e6_=function(param){return get_rec(s,node)};
        return _ce_(feed(s),_e6_)}
      if(0 !== node[2])consume(s,node);
      return return$0(node[2])}
    function next_rec(s,node)
     {if(node === s[4][1])
       {var _e4_=function(param){return next_rec(s,node)};
        return _ce_(feed(s),_e4_)}
      var _e5_=node[2];
      if(_e5_){var x=_e5_[1];consume(s,node);return return$0(x)}
      return fail(Empty$0)}
    ...
    caml_fresh_oo_id(0);
    var html_element=window$0.HTMLElement,jsoo_381e9d7c="2d";
    html_element === empty;
    function unsafeCoerce(tag,e)
     {var _e3_=tag.toString();
      return e.tagName.toLowerCase() === _e3_?e:no_handler}
         ...
         {var
          ...
          try
           {var
             ...
             _e1_=function(callback){return req(callback)};
            return _e1_}
          catch(_e2_)
    ...
    try
     {unix_inet_addr_of_string(_dZ_)}
    catch(_eZ_)
     {_eZ_ = caml_wrap_exception(_eZ_);if(_eZ_[1] !== Failure)throw _eZ_}
    try
     {unix_inet_addr_of_string(_dY_)}
    catch(_eY_)
     {_eY_ = caml_wrap_exception(_eY_);if(_eY_[1] !== Failure)throw _eY_}
    create$1(0,7);
    ...
    function take(t,n)
     {function loop(n,acc)
       {if(0 === n)return return$0(rev(acc));
        function _eX_(x){return loop(n - 1 | 0,[0,x,acc])}
        return _ce_(next_rec(t,t[3]),_eX_)}
      return loop(n,0)}
         ...
         (function(ev)
           {try
             ...
             {exn = caml_wrap_exception(exn);
              ...
              var _eW_=to_string(exn);
              caml_call1(error(_dP_),_eW_)}
            return capt});
     ...
     {return add_event_listener
              (window$0,
               ...
               function(param)
                {return async
                         (function(param)
                           {return catch$0(f,function(_eS_){throw _eS_})})})}
    function get_element_by_id(id,f)
     {var
       x=doc.getElementById(id.toString()),
       _eR_=x == no_handler?no_handler:caml_call1(f,x);
      return _eR_ == no_handler?caml_call1(failwithf(_dQ_),id):_eR_}
    caml_js_eval_string(_dR_);
    function of_array(a)
    ...
    function to_string$0(param)
     {var a=param[4],b=param[3],g=param[2],r=param[1];
      return caml_call4(sprintf(_dU_),r,g,b,a)}
    function create$4(id){return caml_call1(sprintf(_dV_),id)}
    function is_inside(v,target)
     {var match=coords(v),y=match[2],x=match[1],_eN_=0 <= x?1:0;
      if(_eN_)
       {var _eO_=x <= target.clientWidth?1:0;
        if(_eO_)
         var _eP_=0 <= y?1:0,_eQ_=_eP_?y <= target.clientHeight?1:0:_eP_;
        else
         var _eQ_=_eO_}
      else
       var _eQ_=_eN_;
      ...
      if(x === empty)
       {var match=ev.button,switcher=match - 1 | 0;
        if(3 < switcher >>> 0)
         ...
         switch(switcher)
          {case 0:var _eM_=1,switch$0=1;break;
           case 1:var _eM_=3,switch$0=1;break;
           case 2:var switch$0=0;break;
           default:var _eM_=2,switch$0=1}
        if(!switch$0)var _eM_=0;
        var match$0=_eM_}
      else
       var match$0=x;
      switch(match$0)
    ...
    function action$0(jsoo_obj,t$0,kind)
     {var changed_touches$0=t$0.changedTouches,n=changed_touches$0.length;
      function init(i)
       {if(i === n)return 0;
        var _eL_=init(i + 1 | 0);
        return [0,changed_touches$0.item(i),_eL_]}
      var t=init(0);
      function loop(param)
       {var param$0=param;
        for(;;)
    ...
    function draw_circle(t,p,radius)
     {t.beginPath();
      t.arc(p[1],p[2],radius,0,2 * jsoo_obj.PI,jsoo_9f5d45e6);
      return t.fill()}
    function line_to(t,p)
     {var match=coords(p),y=match[2],x=match[1];return t.lineTo(x,y)}
    function set_fill_color(jsoo_obj,color)
     {return jsoo_obj.fillStyle = to_string$0(color).toString()}
    function get_frame(opt,t$0,ctx)
     {if(opt)var sth=opt[1],delay=sth;else var delay=0;
      function _eF_(param)
       {function _eK_(param)
         {ctx.clearRect(0,0,ctx.canvas.clientWidth,ctx.canvas.clientHeight);
          var match=t$0.readyState;
          return 4 <= match
                  ?(ctx.drawImage(t$0,0,0),return$0(0))
                  :get_frame(_dW_,t$0,ctx)}
      ...
      if(delay)
       {var
         ...
         t=match[1],
         d=3e3,
         callback=function(_eJ_){return wakeup(w,_eJ_)},
         id=[0,0],
         loop=
          function(step,param)
           {if(2147483e3 < step)
            ...
            var
             cb=
              remain == 0?callback:function(_eI_){return loop(remain,_eI_)};
        ...
        on_cancel
         (t,
          function(param)
           {var _eH_=id[1];
            if(_eH_){var x=_eH_[1];id[1] = 0;return window$0.clearTimeout(x)}
            return 0});
        var _eG_=t}
      else
       var _eG_=return$0(0);
      return _ce_(_eG_,_eF_)}
    function draw_border(t,ctx,color)
     {ctx.lineWidth = 1;
      ctx.strokeStyle = to_string$0(color).toString();
      var u3=t[4],u2=t[3],u1=t[2],u0=t[1];
      ctx.beginPath();
      var match=coords(u0),y=match[2],x=match[1];
      ctx.moveTo(x,y);
      line_to(ctx,u1);
      line_to(ctx,u2);
      line_to(ctx,u3);
    ...
    function main(param)
     {var
       video$0=get_element_by_id(id,video),
       canvas$0=get_element_by_id(id$0,canvas);
      canvas$0.width = canvas$0.offsetWidth;
      canvas$0.height = canvas$0.offsetHeight;
      var ctx=canvas$0.getContext(jsoo_381e9d7c);
      function _d6_(param)
       {var pos=param[2],prism=param[1];
        function _ei_(image)
         {iter
           (function(t)
             {ctx.save();
              var _eu_=t[3];
              function c$1(_eD_,_eE_){return get(_eu_,_eD_,_eE_)}
              var switch$0=c$1(2,0) == 0?c$1(2,1) == 0?c$1(2,2) == 1?1:0:0:0;
              if(!switch$0)
               {var
                 _et_=0,
                 c=function(_eB_,_eC_){return get(_eu_,_eB_,_eC_)},
                 _ej_=c(2,2),
                 _ek_=c(2,1),
                 _el_=c(2,0),
                 _em_=c(1,2),
                 ...
                 _es_=
                  caml_call9
                   (sprintf(_dS_),_er_,_eq_,_ep_,_eo_,_en_,_em_,_el_,_ek_,_ej_);
                caml_call2(failwithf(_dT_),_es_,_et_)}
              var m=map$0(caml_js_to_array,caml_js_to_array(_eu_));
              function c$2(i,j)
               {return caml_check_bound(caml_check_bound(m,i)[i + 1],j)[j + 1]}
              var
               jsoo_d24db195=c$2(0,0),
               jsoo_5a69c183=c$2(1,0),
               jsoo_2a270bc6=c$2(0,1),
               jsoo_0dfc5f21=c$2(1,1),
               jsoo_aefc3c19=c$2(0,2);
              ctx.setTransform
               (jsoo_d24db195,
                jsoo_5a69c183,
                jsoo_2a270bc6,
                ...
                jsoo_aefc3c19,
                c$2(1,2));
              draw_border(t[2],ctx,blue);
              ctx.restore();
              set_fill_color(ctx,red);
              var v2=pos[3],v1=pos[2],v0=pos[1],_ev_=10,_ew_=t[3];
              function c$0(_ez_,_eA_){return get(_ew_,_ez_,_eA_)}
              function coord(i)
               {var _ex_=c$0(i,2) * v2,_ey_=c$0(i,1) * v1;
                return c$0(i,0) * v0 + _ey_ + _ex_}
              var z=coord(2),y=coord(1),x=coord(0);
              return draw_circle(ctx,[0,x / z,y / z,1],_ev_)},
            prism);
          iter
           (function(t)
             {draw_border(t[2],ctx,green);return draw_border(t[1],ctx,red)},
            prism);
          return return$0(0)}
        var img=doc.createElement("img");
        function _eh_(param){return return$0(img)}
        var match=task(0),w=match[2],t=match[1];
        img.onload
        =
        handler(function(param){wakeup(w,0);return jsoo_9f5d45e6});
        img.src = "honeycomb.png";
        return _ce_(_ce_(t,_eh_),_ei_)}
      function _d5_(markers)
       {function s(i){return nth(markers[2],i)}
        function d(i){return nth(markers[1],i)}
        var
         prism=
          map
           (function(param)
             {var
               ...
               _ec_=s(i3),
               _ed_=s(i2),
               canvas=[0,s(i1),_ed_,_ec_,_eb_],
               _ee_=d(i4),
               _ef_=d(i3),
               _eg_=d(i2),
               camera=[0,d(i1),_eg_,_ef_,_ee_],
               v3=canvas[4],
               v2=canvas[3],
               v1=canvas[2],
               v0=canvas[1],
               ...
               m$0=of_array([0,[254,x1,x2,x3],[254,y1,y2,y3],[254,z1,z2,1]]),
       ...
       {var x$0=[0,x];
        ...
        if(source[2])
         {source[2] = 0;
          ...
          wakeup_later(old_wakener,0)}
        var _ea_=0 === x$0?1:0;
        return _ea_?wakeup(close,0):_ea_}
      add_event_listener
       (target,
        mousedown,
      ...
      function f(param)
       {function _d9_(param)
         {if(param)
           {var x=param[1],_d__=x[2];
            if(_d__)var a=_d__[1],p=a;else var p=failwith(_g_);
            var b=-1032980382 === x[1]?1:0,_d$_=p[2],x$0=b?[0,_d$_]:0;
            return x$0?return$0(x$0):f(0)}
          return return_none}
        return _ce_(get_rec(stream,stream[3]),_d9_)}
      var clicks=from_source([0,[0,f,return_unit]]);
      function _d4_(canvas)
       {iter
         (function(v){set_fill_color(ctx,white);return draw_circle(ctx,v,10)},
          canvas);
        function _d7_(param)
         {function _d8_(camera){return return$0([0,camera,canvas])}
          return _ce_(take(clicks,n),_d8_)}
        return _ce_(get_frame(_dX_,video$0,ctx),_d7_)}
      return _ce_(_ce_(_ce_(take(clicks,n),_d4_),_d5_),_d6_)}
    top_level(main);
    do_at_exit(0);
    return}
